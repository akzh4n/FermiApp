...
import com.example.newfermiapp.QuestionAnswerQuant;
import com.example.newfermiapp.R;

public class QuizQuantActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    int score = 0;
    int totalQuestion = QuestionAnswerQuant.question.length;
    ...
    public void loadNewQuestion() {
        ...
        questionTextView.setText(QuestionAnswerQuant.question[currentQuestionIndex]);
        ansA.setText(QuestionAnswerQuant.choices[currentQuestionIndex][0]);
        ansB.setText(QuestionAnswerQuant.choices[currentQuestionIndex][1]);
        ansC.setText(QuestionAnswerQuant.choices[currentQuestionIndex][2]);
        ansD.setText(QuestionAnswerQuant.choices[currentQuestionIndex][3]);
    }
